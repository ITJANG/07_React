...
export default function Manager() {
  ...
  const handleChange = (e) => {
    const { id, value } = e.target; // 대상의 id 속성값, value 값 꺼내옴
    setForm((prev) => ({
      // 전 상태 가져와서 삽입 중복 값은 덮어씀
      ...prev,
      [id]: value,
    }));
  };
  ...
  async function createAdminAccount() {
    const { email, nickname, tel } = form; // form 상태 안에 있는 값 하나씩 꺼내오기
    ...
    try {
      ...
      // 409 일 때, 500 일 때 응답받은 body 내용이 반영되어 alert 출력할 수 있게끔 함
    }
  }
