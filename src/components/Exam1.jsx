...
class Exam1 extends Component {
  ...
  // 생성자 정의. props는 부모 컴포넌트로부터 전달받은 데이터(name)
  constructor(props) {
    super(); // 부모 클래스(컴포넌트)
  ...
  render() {
    return (
      <div>
        ...
        <h2>부모로부터 전달받은 값 : {this.props.minjang} {this.props.test}</h2>
      </div>
...
// 다른 파일에서 해당 파일(Exam1.jsx)의 기본으로 지정된 컴포넌트(Exam1)를 사용할 수 있도록 내보냄
