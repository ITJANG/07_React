...
// React.createContext() : Context 객체 생성 시 사용하는 함수
// Context : React에서 컴포넌트 계층 구조를 통해 데이터를 효율적으로 전달하기 위한 메커니즘
// Provider : 데이터 제공
// Consumer : 데이터 소비
...
const Child3 = () => {
  // Exam6가 가진 user 상태값을 사용하고 싶음

  // Context로 등록된 객체 중 이름이 UserContext를 꺼내 데이터를 사용
  const contextValue = useContext(UserContext);
